...
class AllArticlesHome extends Component {
  ...
  _onItemClick = (i) => {
    ...
    this.props.history.push(R_ADet)
...
export default connect(mapStateToProps, { getAllArticles })(AllArticlesHome)
